...
function decorate_20223_$4(desc, context) {
    if (process.env.NODE_ENV !== "production") {
        if (context.kind === "field") {
            throw die(
                "Please use `@observable accessor " +
                    String(context.name) +
...
var Reaction = /*#__PURE__*/ (function () {
    ...
    function Reaction(
        ...
        this.delay = void 0
        this.runFirstImmediately = void 0
        this.observing_ = []
        this.newObserving_ = []
        this.dependenciesState_ = IDerivationState_.NOT_TRACKING_
        this.diffValue_ = 0
    ...
    _proto.runReactionImpl = function runReactionImpl() {
        if (!this.isDisposed_) {
            startBatch()
            this.isScheduled_ = false
            ...
            if (shouldCompute(this)) {
                ...
                try {
                    ...
                    if (this.delay) {
                        this.delayTimeouts_.forEach(function (i) {
    ...
    _proto.getDisposer_ = function getDisposer_(abortSignal) {
        ...
        var dispose = function dispose() {
            _this3.dispose()
            _this3.delayTimeouts_.forEach(function (i) {
                return clearTimeout(i)
            })
            abortSignal == null
                ? void 0
...
function autorun(view, opts) {
    ...
    if (
        !(
            (_opts2 = opts) != null &&
            (_opts2$signal = _opts2.signal) != null &&
            _opts2$signal.aborted
        )
    ) {
        reaction.schedule_()
    }
...
function reaction(expression, effect, opts) {
    ...
    if (
        !(
            (_opts4 = opts) != null &&
            (_opts4$signal = _opts4.signal) != null &&
            _opts4$signal.aborted
        )
    ) {
        r.schedule_()
    }
...
function _when(predicate, effect, opts) {
    ...
    var effectAction = createAction(
        process.env.NODE_ENV !== "production" ? opts.name + "-effect" : "When-effect",
        effect
    )
    // eslint-disable-next-line
    ...
    function ObservableArrayAdministration(name, enhancer, owned_, legacyMode_) {
        ...
        this.enhancer_ = function (newV, oldV) {
            return enhancer(
                newV,
                oldV,
                process.env.NODE_ENV !== "production" ? name + "[..]" : "ObservableArray[..]"
            )
        }
    }
...
var ObservableObjectAdministration = /*#__PURE__*/ (function () {
    function ObservableObjectAdministration(
        ...
        this.keysAtom_ = new Atom(
            process.env.NODE_ENV !== "production" ? this.name_ + ".keys" : "ObservableObject.keys"
        )
...
function assertAnnotable(adm, annotation, key) {
  ...
  */
    ...
    if (
        process.env.NODE_ENV !== "production" &&
        !isOverride(annotation) &&
        hasProp(adm.appliedAnnotations_, key)
    ) {
