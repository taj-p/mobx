...
var Reaction = /*#__PURE__*/ (function () {
    ...
    function Reaction(name_, onInvalidate_, errorHandler_, requiresObservable_, scheduler) {
        if (name_ === void 0) {
            name_ = process.env.NODE_ENV !== "production" ? "Reaction@" + getNextId() : "Reaction"
        }
        if (scheduler === void 0) {
            scheduler = function scheduler(f) {
                return f()
            }
        }
        this.name_ = void 0
    ...
    _proto.runReaction_ = function runReaction_() {
        ...
        if (!this.scheduledRunReaction_) {
            ...
            this.scheduler(function () {
                _this.scheduledRunReaction_ = false
                _this.runReactionImpl()
            })
        }
    }
