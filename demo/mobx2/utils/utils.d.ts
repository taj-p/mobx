export declare const assign: {
    ...
    <T_2 extends {}, U_2, V_1, W>(target: T_2, source1: U_2, source2: V_1, source3: W): T_2 &
        U_2 &
        V_1 &
        W
...
export declare const defineProperty: <T>(
    o: T,
    p: PropertyKey,
...
export declare const getOwnPropertyDescriptors: <T>(o: T) => {
